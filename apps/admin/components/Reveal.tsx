 ...
 *
 * Identical implementation to apps/portal/components/Reveal.tsx.
 * Copied (bukan di-share via packages/ui) supaya admin app tetap
 * zero-dependency — admin tidak punya framer-motion/motion di
 * package.json, dan Reveal ini pure vanilla IO + CSS.
 */
