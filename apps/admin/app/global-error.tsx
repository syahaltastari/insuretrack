...
/**
 * Root error boundary. Required untuk production builds — tanpa file ini
 * Next.js 15.0.3 bisa gagal build dengan error `<Html>`-outside-`pages/_document`
 * karena framework internal 500 page coba render dengan pages-router Document,
 * yang tidak ada di pure App-Router apps.
 */
