...
pub const FIRST_NAMES: &[&str] = &[
    "Adi", "Agus", "Andi", "Anton", "Ari", "Arief", "Bayu", "Budi", "Candra",
    "Citra", "Dedi", "Dewi", "Dian", "Eko", "Endang", "Fajar", "Fitri", "Galih",
    "Hadi", "Hana", "Hari", "Indah", "Indra", "Joko", "Juli", "Kartika", "Kiki",
    "Lestari", "Made", "Made", "Nia", "Nugroho", "Putri", "Rangga", "Ratna",
    "Rina", "Rudi", "Sari", "Sinta", "Sri", "Tantri", "Tono", "Wahyu", "Wati",
    "Yanto", "Yusuf", "Zara", "Bagus", "Cahya",
];

/// Nama keluarga umum Indonesia.
pub const LAST_NAMES: &[&str] = &[
    "Wijaya", "Pratama", "Saputra", "Lestari", "Rahmawati", "Setiawan",
    "Nugroho", "Anggraini", "Hidayat", "Kusuma", "Sukma", "Permadi",
    "Handayani", "Maulana", "Pranata", "Wibowo", "Hartono", "Susanto",
    "Surya", "Mahendra", "Pertiwi", "Cahyani", "Gunawan", "Suryanto",
    "Kusnadi", "Pangestu", "Adiputra", "Wulandari", "Sari", "Halim",
];
...
pub const STREETS: &[&str] = &[
    "Jl. Merdeka", "Jl. Sudirman", "Jl. Thamrin", "Jl. Diponegoro",
    "Jl. Hayam Wuruk", "Jl. Asia Afrika", "Jl. Pahlawan", "Jl. Veteran",
    "Jl. Gatot Subroto", "Jl. Ahmad Yani", "Jl. Imam Bonjol", "Jl. Cipto",
    "Jl. Wahid Hasyim", "Jl. Mangunsarkoro", "Jl. Pangeran Antasari",
];
...
pub const CITIES: &[&str] = &[
    ...
    "Yogyakarta", "Denpasar", "Palembang", "Balikpapan", "Manado",
    "Pekanbaru", "Malang", "Bogor", "Depok", "Tangerang", "Bekasi",
    "Cirebon", "Solo", "Pontianak", "Banjarmasin", "Padang", "Jambi",
    "Ambon", "Jayapura", "Kupang", "Mataram", "Samarinda",
];
