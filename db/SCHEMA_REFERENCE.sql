...
CREATE TABLE inquiries (
  ...
  customer_id UUID REFERENCES customers(id) ON DELETE CASCADE,
  policy_id UUID REFERENCES policies(id) ON DELETE
  SET NULL,
...
-- Seed Data: Insert 1 Admin User untuk pengujian tahap awal
-- Password asli: 'admin123' (hash bcrypt sebagai contoh)
INSERT INTO admin_users (username, password_hash)
VALUES (
    'admin',
    '$2b$12$e/hP9.vXJ01H21nU2d3JKe0g2VdE60Wlq6.mR1pL0uV7KkP8d5kR2'
  );